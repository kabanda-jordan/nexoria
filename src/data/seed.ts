...
export const INITIAL_HERO_SLIDES: HeroSlide[] = [
  ...
  {
    id: 'slide-4',
    title_rw: "Ibikoresho byo mu Nzu no mu Gikoni",
    title_en: 'Upgrade Your Home & Kitchen',
    title_fr: 'Modernisez Maison & Cuisine',
    subtitle_rw: "Ibikoresho byuzuye by'inganda zitandukanye ku giciro cyiza, bitangwa vuba hose mu Rwanda.",
    subtitle_en: 'Everything for the modern Rwandan home — cookware, decor & appliances delivered fast.',
    subtitle_fr: 'Tout pour la maison moderne rwandaise — ustensiles, déco et électroménager en livraison rapide.',
    image_url: 'https://images.unsplash.com/photo-1556911220-bff31c812dba?q=80&w=1200&auto=format&fit=crop',
    cta_text_rw: 'Reba Ibikoresho',
    cta_text_en: 'Shop Home Deals',
    cta_text_fr: 'Voir les Offres Maison',
  ...
  {
    id: 'slide-5',
    title_rw: "Agaseke n'Ibikorwa by'Amaboko by'u Rwanda",
    title_en: 'Handcrafted Agaseke & Rwandan Artisans',
    title_fr: 'Agaseke Artisanal & Créations Rwandaises',
    subtitle_rw: "Bambuye mu buhanzi bwo mu Rwanda — agaseke, imyenda y'umwimerere n'imitako.",
    subtitle_en: 'One-of-a-kind baskets, crafts and jewelry woven by local Rwandan hands.',
    subtitle_fr: 'Paniers, artisanat et bijoux uniques tissés par des artisans rwandais.',
    image_url: 'https://images.unsplash.com/photo-1605000797499-95a51c5269ae?q=80&w=1200&auto=format&fit=crop',
    cta_text_rw: 'Gura Umwimerere',
    cta_text_en: 'Shop Authentic Crafts',
    cta_text_fr: 'Acheter Artisanal',
  ...
  {
    id: 'slide-6',
    title_rw: "Imboga n'Ibyo Kurya bishya by'umwaka",
    title_en: 'Fresh Produce Delivered Daily',
    title_fr: 'Produits Frais Livrés Chaque Jour',
    subtitle_rw: "Imboga n'imbuto nshya bituruka mu mirima y'u Rwanda, bikugezwa ku rugi.",
    subtitle_en: 'Farm-fresh fruits and vegetables from Rwandan growers, delivered to your door.',
    subtitle_fr: 'Fruits et légumes frais des fermes rwandaises, livrés à votre porte.',
    image_url: 'https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=1200&auto=format&fit=crop',
    cta_text_rw: 'Gura Bishya',
    cta_text_en: 'Buy Fresh',
    cta_text_fr: 'Acheter Frais',
    category_slug: 'groceries-produce',
    badge: 'DAILY FRESH',
    active: true,
  },
  {
    id: 'slide-7',
    title_rw: 'TV za 4K & Ibyuma bya Kaza',
    title_en: '4K TVs & Latest Electronics',
    title_fr: 'TV 4K & Électronique de Pointe',
    subtitle_rw: "Ibyuma bigezweho byubakwa n'inganda zizwi ku isi — warranty nyarwanda.",
    subtitle_en: 'Brand-new electronics from world-class brands, backed by a local warranty.',
    subtitle_fr: 'Électronique neuve des plus grandes marques, garantie locale incluse.',
    image_url: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?q=80&w=1200&auto=format&fit=crop',
    cta_text_rw: 'Reba Ibyuma',
    cta_text_en: 'Shop Electronics',
    cta_text_fr: 'Voir l\'Électronique',
    category_slug: 'electronics-computers',
    badge: 'BIG SCREEN DEALS',
    active: true,
  },
  {
    id: 'slide-8',
    title_rw: "Iby'Ubwiza by'Umwimerere",
    title_en: 'Natural Beauty & Self-Care',
    title_fr: 'Beauté Naturelle & Soins',
    subtitle_rw: "Ibikoresho by'ubwiza bisukuye mu Rwanda, ku giciro kiryoshye.",
    subtitle_en: 'Clean, locally sourced beauty and skincare products for every budget.',
    subtitle_fr: 'Soins de beauté naturels d\'origine locale, pour tous les budgets.',
    image_url: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&w=1200&auto=format&fit=crop',
    cta_text_rw: 'Gura Ubwiza',
    cta_text_en: 'Shop Beauty',
    cta_text_fr: 'Acheter Beauté',
